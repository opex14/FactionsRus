...
public class LngT {
	...
	public static final String MAIN_CDIS = "<b>Приват теретории отключен в <h>%s<b>.";
	public static final String MAIN_CMEM = "<b>В фракции должно состоять как минимум <h>%s<b> игроков для привата территории.";
	...
	public static final String MAIN_CREL = "<b>Вы не можете заприватить эту территорию из-за ваших отношений с текущим влаадельцем.";
	public static final String MAIN_CSTR = "%s<i> владеет этой территорией и имеет достаточную силу для ее удержания.";
	...
	public static final String MAIN_DLOST = "<i>Вы не потеряли силу после смерти из-за настроек территории.";
	public static final String MAIN_DLOSW = "<i>Вы не потеряли силу после смерти из-за настроек мира.";
	public static final String MAIN_YPOW = "<i>Ваша сила сейчас <h>%.2f / %.2f";
	...
	public static final String MAIN_HTE = "<i>Вы не можете навредить %s<i> на их территории не объявив войну.";
	public static final String MAIN_TH = "%s<i> пытался навредить вам.";
	public static final String MAIN_EDR = "<i>Урон врага понижен <rose>%s<i>.";
	...
	public static final String PLAYER_LEAVE_LEADER = "<b>Вы должны отдать лидера клана. После этого вы сможете выйти из клана";
	...
	public static final String CMD_INVITE_YOU = "%s<i> приглашает вас %s<i>.";
	public static final String CMD_INVITE_INVYR = "%s<i> пригласил %s<i> во фракцию";
	...
	public static final String CMD_JOIN_PJOINED = "<i>%s <i>присоединился в клан %s<i>.";
	...
	public static final String CMD_KICK_FKICKED = "%s<i> кикнул %s<i> из фракции! :O";
